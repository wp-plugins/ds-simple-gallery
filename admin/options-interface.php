 ...
 */
function wrsg_optionsframework_fields() {
    ...
    foreach ($options as $value) {
        ...
        switch ($value['type']) {
            ...
            // Uploader
            case "upload":
                $output .= wrsg_optionsframework_medialibrary_uploader($value['id'], $val, null); // New AJAX Uploader using Media Library	
                break;
            ...
            case 'typography':
                ...
                $faces = wrsg_of_recognized_font_faces();
                ...
                /* Font Style */
                $styles = wrsg_of_recognized_font_styles();
            ...
            case 'background':
                ...
                $output .= wrsg_optionsframework_medialibrary_uploader($value['id'], $background['image'], null, '', 0, 'image');
                ...
                $repeats = wrsg_of_recognized_background_repeat();
                ...
                $positions = wrsg_of_recognized_background_position();
                ...
                $attachments = wrsg_of_recognized_background_attachment();
            ...
            case "info":
                ...
                if ($value['desc']) {
                    $output .= apply_filters('wrsg_of_sanitize_info', $value['desc']) . "\n";
                }
